      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            <Link href="/" className="text-sm font-medium text-slate-700 hover:text-indigo-600 hover:bg-slate-100 px-4 py-2 rounded-xl transition-all duration-200 flex items-center gap-2">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-slate-200 animate-slide-down shadow-sm">
          ...
          <div className="px-2 pt-2 pb-4 space-y-1">
            <Link href="/" className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-base font-medium text-slate-700 hover:text-indigo-600 hover:bg-slate-100 transition-all">
              <Home size={18} /> Home
            </Link>
